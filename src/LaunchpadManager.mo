...
actor class LaunchpadManager() : async Launchpad.LaunchpadManager = this {
  ...
  // Get pricingToken canister, if this canister has been cached, get it from cache directly
  // private func getPricingTokenCanister(): async Token.IToken {
  //   if (pricingTokenCanister == null) {
  //     pricingTokenCanister := ?LaunchpadUtil.getTokenCanister(LaunchpadUtil.PricingToken_CANISTER_ID);
  //   };
  //   switch (pricingTokenCanister) {
  //     case (?pricingToken) {
  //       return pricingToken;
  //     };
  //     case (_) {
  //       throw Error.reject("PricingToken_Canister_does_not_exist");
  //     };
  //   };
  // };
